...
namespace ExampleNameSpace
{
    ...
    public class ExportData : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            string msBoxTitle = Properties.Resources.textPanQtyTitle + " - " + Properties.Resources.textBtnExcelTitle;
            ...
            List<DataHistoryExport> dataExportList = dataAccess.ExportDataToExcel();

            //Export List to Excel
            var wb = new XLWorkbook();
            var ws = wb.Worksheets.Add("DataExport");
            PropertyInfo[] properties = dataExportList.First().GetType().GetProperties();
            ...
            TaskDialog tbg = new TaskDialog("TaskDialog");
